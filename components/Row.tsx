  ...
  return (
    <div className='h-40 space-y-0.5 md:space-y-2'>
        ...
        <div className='group relative md:-ml-2'>
            ...
            opacity-0 hover:scale-125 group-hover:opacity-100 ${!isMoved && 'hidden'}`} onClick={() => handleClick("left")}/>
            ...
            opacity-0 hover:scale-125 group-hover:opacity-100`} onClick={() => handleClick("right")}/>
        </div>
    </div>
  )
}
